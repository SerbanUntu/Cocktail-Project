...
import "./templates"
import AlcoholicIcon from "../../assets/images/alcoholic_icon.png"
		...
		function generateGrid(cocktails: Cocktail[]) {
			cocktails.forEach(cocktail => {
				...
				alcoholicIconContainer.innerHTML = `
                  <img class="alcoholic-icon-image" src="${AlcoholicIcon}" alt="Icon indicating alcohol content" />
                `;
	...
	try {
		...
		data.drinks.forEach((drink: {
			...
			// If we search by ingredient, one call will be made for each drink
				...
				numberOfDrinks = data.drinks.length;
